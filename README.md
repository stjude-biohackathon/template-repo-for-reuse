...
***Edit this template section for your project.***
...
This repository is shared under CC-BY 4.0 for reuse. Originally created as *The Turing Way* template by Malvika Sharan, a copy of this repo is maintained under St. Jude Github Organization through the Office of Data Science.

```


***Please delete all text below this line (after reading) when reusing this repo for different projects.***

## About this Repository

This repository operationalises recommendations and good practices for structuring project repositories to support reproducibility in data science projects.
...
This repository follows the guidance provided in *[The Turing Way](https://book.the-turing-way.org)* handbook to data science.
...
To learn more about how to create a README.md file, please read the [Landing Page - README File](https://book.the-turing-way.org/project-design/project-repo/project-repo-readme.html) chapter in The Turing Way Guide for Project Design.
